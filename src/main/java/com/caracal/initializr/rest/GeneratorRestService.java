package com.caracal.initializr.rest;

import com.caracal.initializr.CaracalGenerator;
...
public class GeneratorRestService {
    ...
    private final CaracalGenerator caracalGenerator;

    @Autowired
    public GeneratorRestService(CaracalGenerator caracalGenerator) {
        this.caracalGenerator = caracalGenerator;
    }
    ...
    public void generateFromJson(@RequestBody String jsonBody) throws IOException {
        ...
        caracalGenerator.generateAll(jsonBody);
    }
